#!/usr/bin/env python3
"""Placeholder collector for Crunchbase user info (scraping pending)."""
...
NOTE = "Access is restricted and enterprise-focused. Scraper flow is pending implementation."
