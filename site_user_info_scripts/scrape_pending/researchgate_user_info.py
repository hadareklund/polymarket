#!/usr/bin/env python3
"""Placeholder collector for ResearchGate user info (scraping pending)."""
...
NOTE = "No usable public username API for this workflow. Scraper flow is pending implementation."
