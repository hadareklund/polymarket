#!/usr/bin/env python3
"""Fetch public info from Telegram t.me pages (HTML scraper for public channels/bots/users)."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Get Telegram public channel/user info by username.")
    parser.add_argument("username", help="Telegram username (without @)")
    parser.add_argument("--timeout", type=int, default=20)
    args = parser.parse_args()
    try:
        url = f"https://t.me/{args.username}"
