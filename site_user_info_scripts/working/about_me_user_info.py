#!/usr/bin/env python3
"""Fetch user profile information from About.me (HTML scraper)."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Get About.me user info by username.")
    parser.add_argument("username", help="About.me username")
    parser.add_argument("--timeout", type=int, default=20)
    args = parser.parse_args()

    try:
        url = f"https://about.me/{args.username}"
        ...
        if isinstance(ld_image, dict):
            ld_image = ld_image.get("url") or ld_image.get("thumbnail_url")
        ...
        result = {
            ...
            "avatar_url": ld_image or _meta(html, "og:image", "property"),
