#!/usr/bin/env python3
"""Fetch user profile information from Odysee (HTML scraper)."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Get Odysee user info by username.")
    parser.add_argument("username", help="Odysee channel name (without @)")
    parser.add_argument("--timeout", type=int, default=20)
    args = parser.parse_args()
    try:
        url = f"https://odysee.com/@{args.username}"
