#!/usr/bin/env python3
"""Fetch user profile information from Flipboard (HTML scraper)."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Get Flipboard user info by username.")
    parser.add_argument("username", help="Flipboard username")
    parser.add_argument("--timeout", type=int, default=20)
    args = parser.parse_args()

    try:
        url = f"https://flipboard.com/@{args.username}"
        ...
        result = {
            ...
            "description": _meta(html, "description") or _meta(html, "og:description", "property"),
