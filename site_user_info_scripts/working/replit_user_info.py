#!/usr/bin/env python3
"""Fetch user profile information from Replit (HTML scraper)."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Get Replit user info by username.")
    parser.add_argument("username", help="Replit username")
    parser.add_argument("--timeout", type=int, default=20)
    args = parser.parse_args()
    try:
        url = f"https://replit.com/@{args.username}"
        ...
        result = {
            ...
            "display_name": display_name or title_raw,
