#!/usr/bin/env python3
"""Fetch user profile information from Tistory (HTML scraper)."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Get Tistory user info by username.")
    parser.add_argument("username", help="Tistory username")
