#!/usr/bin/env python3
"""Fetch user profile information from Weebly (HTML scraper)."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Get Weebly user info by username.")
    parser.add_argument("username", help="Weebly username")
