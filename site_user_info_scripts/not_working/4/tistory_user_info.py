#!/usr/bin/env python3
"""Fetch user/blog profile information from Tistory (HTML scraper).

Tistory blogs are hosted at {username}.tistory.com.
"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Get Tistory blog info by username.")
    parser.add_argument("username", help="Tistory blog username (subdomain)")
    parser.add_argument("--timeout", type=int, default=20)
    args = parser.parse_args()
    try:
        url = f"https://{args.username}.tistory.com"
        ...
        result = {
            ...
            "cover_image": _meta(html, "og:image", "property"),
            "profile_url": url,
        }
        print_json(result)
        return 0
