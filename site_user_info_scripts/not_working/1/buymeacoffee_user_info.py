#!/usr/bin/env python3
"""Fetch user profile information from BuyMeACoffee (HTML scraper)."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Get BuyMeACoffee user info by username.")
    parser.add_argument("username", help="BuyMeACoffee username")
