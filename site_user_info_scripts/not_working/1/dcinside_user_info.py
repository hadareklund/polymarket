#!/usr/bin/env python3
"""Fetch user profile information from DCinside (HTML scraper)."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Get DCinside user info by username.")
    parser.add_argument("username", help="DCinside username")
