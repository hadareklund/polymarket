#!/usr/bin/env python3
"""Fetch user profile information from GoodReads (HTML scraper)."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Get GoodReads user info by username.")
    parser.add_argument("username", help="GoodReads username")
    parser.add_argument("--timeout", type=int, default=20)
    args = parser.parse_args()
    try:
        from common import fetch_text
        url = f"https://www.goodreads.com/{args.username}"
