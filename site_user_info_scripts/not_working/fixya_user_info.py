#!/usr/bin/env python3
"""Fetch user profile information from Fixya (HTML scraper)."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Get Fixya user info by username.")
    parser.add_argument("username", help="Fixya username")
    parser.add_argument("--timeout", type=int, default=20)
    args = parser.parse_args()
    try:
        from common import fetch_text
        url = f"https://www.fixya.com/users/{args.username}"
