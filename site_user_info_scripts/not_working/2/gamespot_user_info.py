#!/usr/bin/env python3
"""Fetch user profile information from GameFAQs (HTML scraper)."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Get GameFAQs user info by username.")
    parser.add_argument("username", help="GameFAQs username")
    parser.add_argument("--timeout", type=int, default=20)
    args = parser.parse_args()
    try:
        from common import fetch_text
        url = f"https://gamefaqs.gamespot.com/community/{args.username}"
