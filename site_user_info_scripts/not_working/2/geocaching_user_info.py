#!/usr/bin/env python3
"""Fetch user profile information from Geocaching (HTML scraper)."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Get Geocaching user info by username.")
    parser.add_argument("username", help="Geocaching username")
    parser.add_argument("--timeout", type=int, default=20)
    args = parser.parse_args()
    try:
        from common import fetch_text
        url = f"https://www.geocaching.com/p/?u={args.username}"
