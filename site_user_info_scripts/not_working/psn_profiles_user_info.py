#!/usr/bin/env python3
"""Fetch user profile information from PSNProfiles (HTML scraper)."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Get PSNProfiles user info by username.")
    parser.add_argument("username", help="PSNProfiles username")
    parser.add_argument("--timeout", type=int, default=20)
    args = parser.parse_args()
    try:
        from common import fetch_text
        url = f"https://psnprofiles.com/{args.username}"
