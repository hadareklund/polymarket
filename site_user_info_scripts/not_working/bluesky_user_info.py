#!/usr/bin/env python3
"""Fetch user profile information from Bluesky."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Get Bluesky user info by username.")
    parser.add_argument("username", help="Bluesky username")
    parser.add_argument("--timeout", type=int, default=20)
    args = parser.parse_args()
    try:
        data = fetch_json(f"https://public.api.bsky.app/xrpc/app.bsky.actor.getProfile?actor={args.username}", timeout=args.timeout)
