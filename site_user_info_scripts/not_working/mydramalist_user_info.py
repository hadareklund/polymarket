#!/usr/bin/env python3
"""Fetch user profile information from MyDramaList (HTML scraper)."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Get MyDramaList user info by username.")
    parser.add_argument("username", help="MyDramaList username")
    parser.add_argument("--timeout", type=int, default=20)
    args = parser.parse_args()
    try:
        from common import fetch_text
        url = f"https://mydramalist.com/profile/{args.username}"
