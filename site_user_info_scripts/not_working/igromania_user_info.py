#!/usr/bin/env python3
"""Fetch user profile information from Igromania (HTML scraper)."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Get Igromania user info by username.")
    parser.add_argument("username", help="Igromania username")
    parser.add_argument("--timeout", type=int, default=20)
    args = parser.parse_args()
    try:
        from common import fetch_text
        url = f"https://forums.igromania.ru/member.php?username={args.username}"
