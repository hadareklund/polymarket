#!/usr/bin/env python3
"""Fetch user profile information from Star Citizen (HTML scraper)."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Get Star Citizen user info by username.")
    parser.add_argument("username", help="Star Citizen username")
