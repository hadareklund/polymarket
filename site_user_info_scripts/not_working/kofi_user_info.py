#!/usr/bin/env python3
"""Fetch user profile information from Ko-fi (HTML scraper)."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Get Ko-fi user info by username.")
    parser.add_argument("username", help="Ko-fi username")
    parser.add_argument("--timeout", type=int, default=20)
    args = parser.parse_args()
    try:
        from common import fetch_text
        url = f"https://ko-fi.com/{args.username}"
