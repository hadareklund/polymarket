#!/usr/bin/env python3
"""Fetch user profile information from Packagist (HTML scraper)."""
...
def main() -> int:
    ...
    parser.add_argument("username", help="Packagist username")
    parser.add_argument("--timeout", type=int, default=20)
    args = parser.parse_args()
    try:
        from common import fetch_text
        url = f"https://packagist.org/users/{args.username}/"
