#!/usr/bin/env python3
"""Fetch user profile information from PepperPL (HTML scraper)."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Get PepperPL user info by username.")
    parser.add_argument("username", help="PepperPL username")
