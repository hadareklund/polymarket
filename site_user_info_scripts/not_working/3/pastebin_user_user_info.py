#!/usr/bin/env python3
"""Fetch user profile information from Pastebin User (HTML scraper)."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Get Pastebin User user info by username.")
    parser.add_argument("username", help="Pastebin User username")
